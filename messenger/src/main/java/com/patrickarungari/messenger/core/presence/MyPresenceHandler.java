package com.patrickarungari.messenger.core.presence;
...
import static com.patrickarungari.messenger.utils.DebugConstants.DEBUG_MY_PRESENCE;
...
public class MyPresenceHandler {
    ...
    public ValueEventListener connect(boolean typing) {
        if (valueEventListener == null) {
            valueEventListener = connectedRef.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot snapshot) {
