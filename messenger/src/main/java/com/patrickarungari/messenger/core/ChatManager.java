package com.patrickarungari.messenger.core;
...
import com.patrickarungari.messenger.core.authentication.ChatAuthentication;
import com.patrickarungari.messenger.core.chat_groups.syncronizers.GroupsSyncronizer;
import com.patrickarungari.messenger.core.contacts.listeners.OnContactCreatedCallback;
...
import com.patrickarungari.messenger.ui.login.listeners.OnLogoutClickListener;
...
//        IOUtils.saveObjectToFile(context, _SERIALIZED_CHAT_CONFIGURATION_LOGGED_USER, currentUser);
    ...
    public void performLogout(OnLogoutClickListener onLogoutClickListener) {
        ...
        tokenNode.removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
