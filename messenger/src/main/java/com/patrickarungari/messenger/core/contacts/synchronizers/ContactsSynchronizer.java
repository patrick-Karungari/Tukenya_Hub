package com.patrickarungari.messenger.core.contacts.synchronizers;
...
import com.patrickarungari.messenger.core.contacts.listeners.ContactListener;
...
import static com.patrickarungari.messenger.utils.DebugConstants.DEBUG_CONTACTS_SYNC;
                            ...
                            new Thread(new Runnable() {
                                public void run() {
                                    ...
                                    try {
                                        ...
                                        if(!FirebaseAuth.getInstance().getCurrentUser().getUid().equals(contact.getId())){
                                            addContact(contact);
                                        }
