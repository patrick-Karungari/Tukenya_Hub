package com.patrickarungari.messenger.core.conversations;
...
import com.patrickarungari.messenger.core.conversations.listeners.UnreadConversationsCountListener;
import com.patrickarungari.messenger.core.conversations.listeners.UnreadConversationsListener;
...
public class ConversationsHandler {
    ...
    private final DatabaseReference messagesNode;
    ...
    private List<UnreadConversationsCountListener> unreadConversationsCountListeners;
    private ValueEventListener unreadConversationsValueEventListener;
    private ValueEventListener unreadConversationsCountValueEventListener;
    ...
    public ConversationsHandler(String firebaseUrl, String appId, String currentUserId) {
        ...
        unreadConversationsCountListeners  = new ArrayList<>();
        ...
        if (StringUtils.isValid(firebaseUrl)) {
            this.messagesNode = FirebaseDatabase.getInstance()
                    .getReferenceFromUrl(firebaseUrl)
        ...
        this.messagesNode.keepSynced(true);
