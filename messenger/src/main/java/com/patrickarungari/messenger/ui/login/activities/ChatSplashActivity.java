...
//        FirebaseUser currentUser = mAuth.getCurrentUser();
    ...
    final protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d(DebugConstants.DEBUG_LOGIN, "ChatSplashActivity.onActivityResult: requestCode == " + requestCode + " resultCode == " + requestCode);
    ...
    private void runDispatch() {
        ...
        if (FirebaseAuth.getInstance().getCurrentUser() != null) {
            Log.d(DebugConstants.DEBUG_LOGIN, "ChatSplashActivity.runDispatch: user is logged in. Goto : " + getTargetClass().getName());
