package com.patrickarungari.messenger.ui.users.activities;
...
public class PublicProfileActivity extends AppCompatActivity implements PresenceListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mUID.setText(contact.getRegNum());
...
//                .bitmapTransform(new CropCircleTransformation(getApplicationContext()))
    ...
    public void isUserOnline(boolean isConnected) {
        Log.d(DebugConstants.DEBUG_USER_PRESENCE, "PublicProfileActivity.isUserOnline: " +
    ...
    public void userLastOnline(long lastOnline) {
        Log.d(DebugConstants.DEBUG_USER_PRESENCE, "PublicProfileActivity.userLastOnline: " +
    ...
    public void onPresenceError(Exception e) {
        Log.e(DebugConstants.DEBUG_USER_PRESENCE, "PublicProfileActivity.onMyPresenceError: " + e.toString());
