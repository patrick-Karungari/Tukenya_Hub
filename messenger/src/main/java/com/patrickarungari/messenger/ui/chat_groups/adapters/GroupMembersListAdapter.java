package com.patrickarungari.messenger.ui.chat_groups.adapters;
...
//        Log.d(TAG, "onBindViewHolder");
        ...
        if (StringUtils.isValid(contact.getFullName())){
            ...
            if (contact.getId().equals(ChatManager.getInstance().getLoggedUser().getId())) {
                holder.contact.setText("You");
            } else {
                holder.contact.setText(contact.getId());
            }
        }
