...
import com.patrickarungari.messenger.ui.chat_groups.adapters.GroupMembersListAdapter;
import com.patrickarungari.messenger.ui.chat_groups.fragments.BottomSheetGroupAdminPanelMember;
import com.patrickarungari.messenger.ui.chat_groups.listeners.OnGroupMemberClickListener;
import com.patrickarungari.messenger.ui.decorations.ItemDecoration;

import java.util.ArrayList;
import java.util.List;

import static com.patrickarungari.messenger.ui.ChatUI.BUNDLE_CHAT_GROUP;
import static com.patrickarungari.messenger.ui.ChatUI.BUNDLE_GROUP_ID;
    ...
    private void setCreatedBy() {
        ...
        for (IChatUser member : chatGroup.getMembersList()) {
            if (member.getId().equals(chatGroup.getOwner())) {
                if (loggedUser.getId()
                        .equals(chatGroup.getOwner())){
                    creator = loggedUser.getFullName();}
                else {
